...
O Miniola nasceu rodando no Raspberry Pi 5 e 4. Embora o Raspberry Pi 5 seja excelente e compacto, existem cenários onde o usuário ou instituição arquivística já possui computadores compactos potentes — rodando Linux (`x86_64`), Intel NUCs ou MiniPCs industriais com portas USB 3.0 rápidas e discos SSD internos.
